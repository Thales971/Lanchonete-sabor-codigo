...
export const criar = async (req, res) => {
  try {
    ...
    if (!cpf)
      return res
        .status(400)
        .json({ error: true, message: 'O campo "cpf" é obrigatório.' });
...
export const buscarTodos = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: true, message: "Erro ao buscar clientes." });
  }
};
...
export const buscarPorId = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: true, message: "Erro ao buscar cliente." });
  }
};
...
export const atualizar = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: true, message: "Erro ao atualizar cliente." });
  }
};
...
export const deletar = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: true, message: "Erro ao deletar cliente." });
  }
};
